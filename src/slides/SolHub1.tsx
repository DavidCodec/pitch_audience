			...
			<div className="max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 md:gap-8 mb-6 sm:mb-8">
				...
				>
					<AnimatedIcon delay={0.4}>
						<Database className="w-12 h-12 sm:w-16 sm:h-16 md:w-20 md:h-20 text-red-400 mb-3 sm:mb-4" />
					</AnimatedIcon>
					<AnimatedText delay={0.6}>
						<h3 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold text-white">El Problema</h3>
					</AnimatedText>
				</AnimatedCard>
				...
				>
					<AnimatedIcon delay={0.6}>
						<Shield className="w-12 h-12 sm:w-16 sm:h-16 md:w-20 md:h-20 text-green-400 mb-3 sm:mb-4" />
					</AnimatedIcon>
					<AnimatedText delay={0.8}>
						<h3 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold text-white">Nuestra Solución</h3>
					</AnimatedText>
				</AnimatedCard>
				...
				>
					<AnimatedIcon delay={0.8}>
						<Users className="w-12 h-12 sm:w-16 sm:h-16 md:w-20 md:h-20 text-blue-400 mb-3 sm:mb-4" />
					</AnimatedIcon>
					<AnimatedText delay={1.0}>
						<h3 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold text-white">Beneficios</h3>
					</AnimatedText>
				</AnimatedCard>
				...
				>
					...
					<AnimatedText delay={1.2}>
						<h3 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold text-white">Nuestro Mercado</h3>
					</AnimatedText>
				</AnimatedCard>
			</div>
				...
				>
					<div className="flex flex-col sm:flex-row items-center justify-center mb-3 sm:mb-4">
						<AnimatedIcon delay={1.8}>
							<Shield className="w-6 h-6 sm:w-8 sm:h-8 text-white mb-2 sm:mb-0 sm:mr-2" />
						</AnimatedIcon>
						<AnimatedText delay={2.0}>
							<h3 className="text-lg sm:text-xl md:text-2xl font-bold text-white text-center">La Fórmula SolHub</h3>
						</AnimatedText>
					</div>
